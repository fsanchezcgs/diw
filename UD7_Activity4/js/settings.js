...
function collectUsers() {
  let request = db
    .transaction("franciscoUsers")
    .objectStore("franciscoUsers")
    .getAll();

  request.onsuccess = () => {
    let requestDbLogged = dbLogged
